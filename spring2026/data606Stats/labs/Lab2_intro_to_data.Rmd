...
**Not really from what I'm saying, all I can tell is that most flights are either on time or slightly delayed there are of course a couple flights that are delayed by various amount of hours, but most flights are on time or close to it**
...
** The distribution is leaning towards early arrivals both the main and the median are negatives and the IQR is 23 minutes, there is a few outliers, but none the less the flights tend to arrive earlier**
...
** The mean takes into account the whole data so it is influenced by any extreme outliers. I would rather take into account these outliers because I would rather wait two hours then have the possibility of having to stay in the airport overnight.**
