...
**With the code above the trend we see is that over the years the number of girls baptized went up, although from the years 1640-1660 and 1700-1710 we see a sudden drop in the numbers; that sort of contradict the trend claimed above, but after a quick search I believe that's due to the wars and tensions in Europe and the British colonies in america.**
...
**From 1940 to 2002, the dimensions of the present data set is 63 by 3,the variable names are year, boys, girls**

1.  How do these counts compare to Arbuthnot's? Are they of a similar magnitude?

**The magnitude is alot more ,by almost a factor of 200**
...
**actually the proportion of boys slightly decreases as we get closer to present day **
